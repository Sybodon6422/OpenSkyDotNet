...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670765, ; uint32_t jnienv_initialize_method_token (0x6001d2d)
	i32 100670764, ; uint32_t jnienv_registerjninatives_method_token (0x6001d2c)
...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3543944121087594168, ; hash 0x312e9e66c9428eb8, from name: OpenSkysDotNet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 94
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4362751341059582425, ; hash 0x3c8b9b3ad73729d9, from name: aot-OpenSkysDotNet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 114
	...
	%struct.DSOCacheEntry {
		i64 12591194708537143931, ; hash 0xaebce8e05c22727b, from name: OpenSkysDotNet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 335
	...
	%struct.DSOCacheEntry {
		i64 13129388143501698949, ; hash 0xb634f4f43ba4e785, from name: aot-OpenSkysDotNet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 13924791468963518766, ; hash 0xc13ecc1076f5d92e, from name: libaot-OpenSkysDotNet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 377
	...
	%struct.DSOCacheEntry {
		i64 16522087132608917201, ; hash 0xe54a3eb59734eed1, from name: libaot-OpenSkysDotNet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 449
...
@.env.3 = private unnamed_addr constant [37 x i8] c"3d4d9720-5017-4c43-be32-12de54e9baf5\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.BarkerSybodon.OpenSkysDotNet\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [29 x i8] c"libaot-OpenSkysDotNet.dll.so\00", align 16
