...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3250593286118080595, ; hash 0x2d1c6d5f10568053, from name: libaot-Weather++
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 82
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5384909152012912030, ; hash 0x4abb0a57e17ac59e, from name: Weather++.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 5954873554673122394, ; hash 0x52a3f5f29ca8bc5a, from name: aot-Weather++.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 141
	...
	%struct.DSOCacheEntry {
		i64 7204442671234847731, ; hash 0x63fb52704f9e93f3, from name: Weather++
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 170
	%struct.DSOCacheEntry {
		i64 7205237404037910326, ; hash 0x63fe253e76098f36, from name: libaot-Weather++.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 171
	...
	%struct.DSOCacheEntry {
		i64 18439771769074126170, ; hash 0xffe73ab9d2f08d5a, from name: aot-Weather++
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 496
...
@.env.3 = private unnamed_addr constant [37 x i8] c"709f5e78-5513-49aa-b634-94faabfc8a8e\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.weather\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-Weather++.dll.so\00", align 16
