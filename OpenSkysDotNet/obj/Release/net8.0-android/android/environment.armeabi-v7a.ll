...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 632963954, ; hash 0x25ba4372, from name: Weather++
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 826784846, ; hash 0x3147bc4e, from name: aot-Weather++.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 85
	...
	%struct.DSOCacheEntry {
		i64 1189023266, ; hash 0x46df0e22, from name: Weather++.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 131
	...
	%struct.DSOCacheEntry {
		i64 1594071780, ; hash 0x5f039ae4, from name: aot-Weather++
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 175
	...
	%struct.DSOCacheEntry {
		i64 2693072717, ; hash 0xa085074d, from name: libaot-Weather++.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 313
	...
	%struct.DSOCacheEntry {
		i64 3487399467, ; hash 0xcfdd7e2b, from name: libaot-Weather++
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Weather++.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
