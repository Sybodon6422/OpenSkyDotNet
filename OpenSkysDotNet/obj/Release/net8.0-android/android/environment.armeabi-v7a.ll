...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 56143592, ; hash 0x358aee8, from name: aot-OpenSkysDotNet.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 158141655, ; hash 0x96d0cd7, from name: OpenSkysDotNet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 13
	...
	%struct.DSOCacheEntry {
		i64 1849396701, ; hash 0x6e3b8ddd, from name: libaot-OpenSkysDotNet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 203
	...
	%struct.DSOCacheEntry {
		i64 2674098296, ; hash 0x9f638078, from name: aot-OpenSkysDotNet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 308
	...
	%struct.DSOCacheEntry {
		i64 2979373727, ; hash 0xb195a29f, from name: libaot-OpenSkysDotNet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 4200359613, ; hash 0xfa5c66bd, from name: OpenSkysDotNet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-OpenSkysDotNet.dll.so
		ptr null; void* handle (0x0)
	}, ; 490
